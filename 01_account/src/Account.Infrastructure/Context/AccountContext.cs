...
public partial class AccountContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("C_TRoles_PK");

            entity.ToTable("TRoles", "sch_acc");

            entity.HasIndex(e => e.AccountId, "IDX_TRoles_AccountId");

            entity.HasIndex(e => e.ContactId, "IDX_TRoles_ContactId");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.TRoles)
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("C_TAccount_TRoles_FK");

            entity.HasOne(d => d.Contact).WithMany(p => p.TRoles)
