...
SET @contactNexity1 = (SELECT ContactId FROM actor.TContact WHERE ContactGlobalUniqueId = '24B47B42-8A1E-45E1-A976-6AE844778A97');
SET @contactNexity2 = (SELECT ContactId FROM actor.TContact WHERE ContactGlobalUniqueId = 'D6994F9A-017A-4144-AF47-F973AB517268');
