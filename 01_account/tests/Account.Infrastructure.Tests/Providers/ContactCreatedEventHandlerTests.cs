...
public class ContactCreatedEventHandlerTests
{
    ...
    public async Task HandleAsync_WithExistingRole_ShouldCreatesContactButNotRole()
    {
        ...
        _roleEventPublisherMock.Verify(x => x.PublishRoleCreatedEventAsync(It.IsAny<CreateRoleRequest>(), It.IsAny<string>(), It.IsAny<bool>()), Times.Never);
    ...
    public async Task HandleAsync_WithValidMessage_And_AccountNumber_ShouldCreateContactAndRole()
    {
        ...
        _roleEventRepositoryMock.Setup(r => r.CreateRoleForNewContactAsync(It.IsAny<int>(), It.IsAny<int>()))
            ...
            .Verifiable();
        _roleEventPublisherMock.Setup(r => r.PublishRoleCreatedEventAsync(It.IsAny<CreateRoleRequest>(), It.IsAny<string>(), It.IsAny<bool>()))
            .Verifiable();
        ...
        _roleEventPublisherMock.Verify(x => x.PublishRoleCreatedEventAsync(It.IsAny<CreateRoleRequest>(), It.IsAny<string>(), It.IsAny<bool>()), Times.Once);
