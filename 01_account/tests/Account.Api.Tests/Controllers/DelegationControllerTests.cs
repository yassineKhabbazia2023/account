...
public class DelegationControllerTests
{
    ...
    {
        _service.Setup(x => x.DeleteDelegationAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>())).Returns(Task.CompletedTask);

        var controller = new DelegationController(_service.Object);

        var result = await controller.DeleteDelegationAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>());
    ...
    public async Task DeleteDelegationAsync_WhenDelegationNotExist_ShouldThrowException()
    {
        ...
        _service.Setup(x => x.DeleteDelegationAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>())).ThrowsAsync(exception);

        var controller = new DelegationController(_service.Object);

        var result = await Assert.ThrowsAsync<NotFoundException>(async () => await controller.DeleteDelegationAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>()));
